...
export const createProductReviewResponsesStepId =
	"create-product-review-response-step";
...
>(
	...
	async (data, { container }) => {
		const productReviewResponseService =
			container.resolve<ProductReviewResponseService>(PRODUCT_REVIEW_MODULE);

		const createdResponses =
			(await productReviewResponseService.createProductReviewResponses(
				data,
