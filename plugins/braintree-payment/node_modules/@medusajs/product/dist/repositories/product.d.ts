...
export declare class ProductRepository extends ProductRepository_base {
    ...
    deepUpdate(updates: any[], validateVariantOptions: (variants: any[], options: InferEntityType<typeof ProductOption>[]) => void, context?: Context): Promise<InferEntityType<typeof Product>[]>;
    protected correctUpdateDTOTypes(update: any): void;
    /**
