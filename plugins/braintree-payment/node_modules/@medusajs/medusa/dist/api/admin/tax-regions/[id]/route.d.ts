...
export declare const GET: (req: AuthenticatedMedusaRequest<HttpTypes.AdminUpdateTaxRegion>, res: MedusaResponse<HttpTypes.AdminTaxRegionResponse>) => Promise<void>;
