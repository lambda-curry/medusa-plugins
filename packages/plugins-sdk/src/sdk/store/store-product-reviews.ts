...
export class StoreProductReviewsResource {
  ...
  async upsert(data: StoreUpsertProductReviewsDTO, headers?: ClientHeaders) {
    return this.client.fetch<StoreUpsertProductReviewsResponse>(
  ...
  async list(query: StoreListProductReviewsQuery, headers?: ClientHeaders) {
    return this.client.fetch<StoreListProductReviewsResponse>(
      '/store/product-reviews',
      {
        method: 'GET',
        query,
  ...
  async listStats(
    ...
    return this.client.fetch<StoreListProductReviewStatsResponse>(
