...
export const listStoreProductReviewStatsQuerySchema = createFindParams({
  offset: 0,
  limit: 50,
}).merge(
  z.object({
...
export const storeProductReviewStatRoutesMiddlewares: MiddlewareRoute[] = [
  {
    ...
    method: 'GET',
    middlewares: [
      validateAndTransformQuery(listStoreProductReviewStatsQuerySchema, defaultStoreProductReviewStatsQueryConfig),
    ],
  },
];
